  ...
  <div class="flex flex-col justify-center items-center">
    ...
    <div v-if="fetchSuccess">
      <main class="flex flex-col flex-nowrap justify-center items-center h-96">
        <ul class="flex flex-row flex-nowrap justify-center items-start w-9/12 min-h-full h-80 mt-48">
          ...
          <li class="flex flex-col flex-nowrap justify-around items-center w-9/12 min-h-full ml-32 mr-32 border shadow-md">
        ...
        <div class="flex flex-row flex-nowrap justify-around items-center w-9/12 h-24 mt-8 ml-44">
          <button
