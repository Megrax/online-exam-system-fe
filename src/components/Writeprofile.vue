<template>
  <div class="mt-16 ml-40 mb-24">
        ...
        <li class="mt-5 ml-10">
          <ul class="flex flex-row flex-nowrap">
            <li class="flex flex-col flex-nowrap">
              <label>{{ this.sectionInfo.avatar }}</label>
            </li>
            <li class="flex flex-col flex-nowrap ml-4">
              <img
                      :src="avatarUrl"
                      class="w-20 h-20"
              >
            ...
            <li class="flex flex-col flex-nowrap ml-4">
              <span class="text-greyText text-sm">{{ this.tips.avatar }}</span>
            </li>
          </ul>
        </li>
        <li class=" mt-5 ml-10">
          <ul class="flex flex-col flex-nowrap">
            <li>
              <lable>{{ this.sectionInfo.sex }}</lable>
              <input
                      type="radio"
                      :value="男"
                      id="man"
    ...
    <button class="mt-10 ml-10 bg-submit text-white h-10 w-20">{{ this.sectionInfo.save }}</button>
  </div>
</template>
